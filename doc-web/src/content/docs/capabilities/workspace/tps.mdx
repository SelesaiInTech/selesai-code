...
- Live numbers are estimates by design and need a minimum sample window; readings above the plausible maximum are dropped, while the final main-model figure passes the full reliability gates.
