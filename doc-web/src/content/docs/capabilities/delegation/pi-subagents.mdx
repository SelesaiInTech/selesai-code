...
- The bundled `workflow` skill is parent guidance for coordinating pi-subagents, not a fixed slash-command pipeline. It selects only the reconnaissance, planning, writing, review, and fix stages a task needs.
