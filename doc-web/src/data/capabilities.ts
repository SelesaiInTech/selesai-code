...
export const capabilities: Capability[] = [
  ...
  {
    slug: "jev-advisory-routing",
    category: "terminal-workspace",
    en: { displayName: "Jev advisory routing", benefit: "Opt-in bounded, read-only memory lookups and skill, workflow, or verification recommendations." },
    id: { displayName: "Perutean advisory Jev", benefit: "Pencarian memori read-only yang dibatasi serta rekomendasi skill, workflow, atau verifikasi yang opt-in." },
    sourcePaths: ["src/extensions/jev-advisory-routing.ts", "src/extensions/jev/decisions.ts", "docs/settings.md"],
    sourceLinks: [
      links("Advisory routing source", "src/extensions/jev-advisory-routing.ts"),
      links("Settings reference", "docs/settings.md"),
    ],
    guideRoute: "capabilities/workspace/jev-advisory-routing",
    piComparison: "core-differentiator",
    distribution: "bundled",
