...
export class AgentSession {
	...
	async sendUserMessage(
		...
		// Use prompt() with expandPromptTemplates to control command handling and template expansion
	...
	/** Generate the built-in compaction summary for manual and automatic compaction. */
	...
	setSessionName(name: string): void {
		...
		this._emit({ type: "session_info_changed", name: sessionName });
		void this._extensionRunner.emit({ type: "session_info_changed", name: sessionName });
	}
