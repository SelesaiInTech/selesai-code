 ...
 * Encodes cwd into a safe directory name under the configured agent sessions directory.
 */
...
export class SessionManager {
	 ...
	 * @param sessionDir Optional session directory. If omitted, uses the configured agent sessions directory.
	 */
