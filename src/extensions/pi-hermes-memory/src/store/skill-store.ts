 ...
 *
 * Global skills live in ~/.selesai/agent/pi-hermes-memory/skills/<slug>/SKILL.md.
 * Project skills live in ~/.selesai/agent/<projectsMemoryDir>/<project>/skills/<slug>/SKILL.md.
 */
...
export class SkillStore {
   ...
   *
   * Pi keys skills by name, first-loaded wins, and `~/.selesai/agent/skills/` is
