...
export interface MemoryConfig {
  ...
  /** Override extension storage directory. Default: ~/.selesai/agent/pi-hermes-memory */
  memoryDir?: string;
  /** Directory for project-scoped memory (relative to ~/.selesai/agent). Default: "projects-memory" */
