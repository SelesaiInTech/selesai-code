...
export function resolveProjectSkillDiscovery(
  ...
  // Pi auto-discovers its own `~/.selesai/agent/skills/`, but this extension keeps
...
export default function (pi: ExtensionAPI) {
  ...
  // ~/.selesai/agent/<project>/ layout. This is non-destructive: legacy folders
  ...
  // Project-scoped store: ~/.selesai/agent/<projectsMemoryDir>/<project_name>/
