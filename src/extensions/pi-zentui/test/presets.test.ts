...
describe("component presets", () => {
	...
	it("leaves the Selesai defaults unchanged and classified as custom", () => {
		expect(matchingComponentPreset(defaultConfig)).toBeUndefined();
		expect(matchingComponentPreset(mergeConfig({}))).toBeUndefined();
	});
