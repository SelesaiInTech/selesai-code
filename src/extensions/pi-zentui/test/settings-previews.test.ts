...
function config(): PolishedTuiConfig {
	...
	current.icons.mode = "nerd";
	current.components.editor.enabled = true;
	current.components.editor.viewportIndicators = true;
	current.components.editor.styles.opencode.completionMenu = "palette";
	current.components.editor.styles["opencode-copy-friendly"].completionMenu = "palette";
	current.components.editor.modelLabel = "id";
	current.components.editor.borderColorMode = "static";
	return current;
}
