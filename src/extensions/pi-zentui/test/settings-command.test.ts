...
function cloneConfig(): PolishedTuiConfig {
	...
	config.components.editor.modelLabel = "id";
	config.components.editor.viewportIndicators = true;
	config.components.editor.styles.opencode.completionMenu = "palette";
	config.components.editor.styles["opencode-copy-friendly"].completionMenu = "palette";
	config.components.editor.styles.minimalist.contextGauge = false;
	...
	config.components.footer.modelLabel = "id";
	config.components.footer.styles.starship.compactMaxLines = 2;
	config.components.footer.styles.starship.separator = "pipe";
	config.components.footer.styles.starship.pathDisplay.depth = 0;
	config.components.footer.styles.starship.segments.gitMetrics = false;
	return config;
}
