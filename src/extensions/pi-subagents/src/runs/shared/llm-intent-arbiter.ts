 ...
 *
 * Enabled by default; set SELESAI_SUBAGENTS_LLM_INTENT_ARBITER=0 to disable.
 */
...
async function runArbitration(
	...
	const agent = new Agent({
		...
		convertToLlm,
		streamFn: authWrappedStreamFn(runtime.baseStreamFn, auth),
...
export function createTaskMutationArbiter(
	...
	if (process.env.SELESAI_SUBAGENTS_LLM_INTENT_ARBITER === "0") return undefined;
