...
export const WAIT_TOOL_ENABLED_ENV = "SELESAI_SUBAGENT_WAIT_TOOL_ENABLED";
export const WAIT_TOOL_DEFAULT_TIMEOUT_MS_ENV = "SELESAI_SUBAGENT_WAIT_TOOL_DEFAULT_TIMEOUT_MS";
