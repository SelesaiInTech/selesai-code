...
Alternatively, dispatch a scripted parallel researcher wave (\`{ workflowScript, output: false }\`) to fan out the research; the parent still writes research.md via write_workflow_artifact.
